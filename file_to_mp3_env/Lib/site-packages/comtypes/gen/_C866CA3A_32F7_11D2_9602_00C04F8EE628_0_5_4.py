...
__all__ = [
    'SPSHT_NotOverriden', 'SP_VISEME_21', 'WAVEFORMATEX',
    ...
    'eLEXTYPE_PRIVATE2', 'DISPID_SLWType', 'SPLOADOPTIONS',
    'eLEXTYPE_RESERVED8', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SPEAudioSizeBytes', 'SVP_10', 'SpeechAudioFormatGUIDWave',
    'SpeechRuleState', 'SPEI_END_INPUT_STREAM',
    'DISPID_SpeechLexiconWord', 'DISPID_SpeechRecognizerStatus',
    'SVP_5', 'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SVEWord',
    'DISPID_SRRTimes', 'DISPID_SPANumberOfElementsInResult',
    'SAFT44kHz16BitStereo', 'DISPID_SLPSymbolic',
    'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SpeechObjectTokenCategory',
    'SRSEIsSpeaking', 'SRTReSent', 'SRSActive',
    'SAFTGSM610_44kHzMono', 'SPVPRI_NORMAL', 'SPSHT_OTHER',
    'DISPID_SPPFirstElement', 'SPXMLRESULTOPTIONS', 'SVP_9',
    'DISPID_SRRTStreamTime', 'SPEI_START_SR_STREAM',
    'DISPID_SRRSpeakAudio', 'ISpRecognizer', 'ISpeechAudio',
    'SPRECOGNIZERSTATUS', 'DISPID_SVStatus', 'SpeechStreamFileMode',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechAudioFormatType',
    'ISpeechLexicon', 'SAFTGSM610_8kHzMono', 'SECHighConfidence',
    'SVSFIsNotXML', 'DISPID_SPERetainedSizeBytes', 'SPVPRIORITY',
    'SAFTADPCM_22kHzMono', 'DISPID_SRRSaveToMemory', 'SVSFVoiceMask',
    'SAFT11kHz8BitStereo', 'SVESentenceBoundary',
    'SAFT8kHz8BitStereo', 'SPCT_COMMAND',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SITooSlow',
    'DISPID_SGRSAddRuleTransition', 'SPRST_INACTIVE', 'SREBookmark',
    'SPEVENTSOURCEINFO', 'SPPS_Interjection', 'SREAudioLevel',
    'SAFTText', 'DISPID_SVResume', 'DISPID_SpeechPhraseAlternate',
    'SPSERIALIZEDPHRASE', 'SBOPause', 'DISPID_SPRuleParent',
    'DISPID_SPACommit', 'SRAExport', 'DISPID_SOTRemove',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SPIRule',
    'SpeechAudioFormatGUIDText', '_ISpeechVoiceEvents',
    'SPEI_RESERVED6', 'SAFT22kHz8BitStereo', 'SECFIgnoreKanaType',
    'ISpShortcut', 'DISPID_SWFEChannels', 'DISPID_SOTGetDescription',
    'SAFTCCITT_uLaw_8kHzMono', 'SP_VISEME_1', 'SVSFPurgeBeforeSpeak',
    'SWTDeleted', 'SPEI_WORD_BOUNDARY', 'DISPID_SGRsCommit',
    'SAFT12kHz16BitMono', 'SPEI_INTERFERENCE', 'SRESoundEnd',
    'SpeechPropertyHighConfidenceThreshold', 'SPAR_Unknown',
    'DISPID_SpeechPhraseProperty', 'SVP_15', 'DISPID_SpeechDataKey',
    'SVSFIsFilename', 'SDKLLocalMachine', 'eLEXTYPE_PRIVATE9',
    'SPEI_RECO_STATE_CHANGE', 'SGDSInactive', 'SVP_11',
    'ISpeechRecoResultDispatch', 'SRESoundStart', 'SPPS_SuppressWord',
    'DISPID_SPISaveToMemory', 'DISPID_SRSClsidEngine', 'SPPS_Unknown',
    'SpNotifyTranslator', 'DISPID_SAVolume', 'SVPAlert',
    'SPDKL_LocalMachine', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SpeechLexiconWords', 'DISPID_SABIMinNotification',
    'SREInterference', 'SPVPRI_ALERT', 'DISPID_SVVolume',
    'SECFDefault', 'DISPID_SVSInputWordLength',
    'SpeechCategoryAudioOut', 'SPEI_MIN_TTS',
    'DISPID_SRGDictationSetState', 'SSTTTextBuffer',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SFSOpen',
    'DISPID_SVGetVoices', 'DISPID_SRCCmdMaxAlternates',
    'ISpeechVoice', 'DISPID_SRCEEnginePrivate', 'SP_VISEME_9',
    'SpMMAudioOut', 'SpeechInterference', 'SPEI_SR_RETAINEDAUDIO',
    'SPDKL_CurrentUser', 'DISPID_SRGDictationLoad',
    'SAFT16kHz8BitStereo', 'SpeechEngineConfidence',
    'ISpeechPhraseProperty', 'SSFMCreateForWrite',
    'DISPID_SPPConfidence', 'DISPID_SAFGuid',
    'DISPID_SDKSetBinaryValue',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SPRuleEngineConfidence', 'SGRSTTEpsilon',
    'ISpeechRecoContext', 'SpLexicon', 'SPEI_VISEME',
    'DISPID_SPPParent', 'SpeechVoicePriority',
    'DISPID_SDKSetStringValue', 'SpeechAddRemoveWord',
    'DISPID_SRRTLength', 'DISPID_SLWLangId',
    'DISPID_SRGIsPronounceable', 'SVP_0', 'SDKLCurrentUser',
    'SPSInterjection', 'SPFM_OPEN_READWRITE',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SASPause', 'SREStateChange',
    'SVEBookmark', 'DISPID_SRCCreateResultFromMemory', 'SP_VISEME_12',
    'SVF_Stressed', 'SPAR_Low', 'DISPID_SDKGetBinaryValue',
    'LONG_PTR', 'SGSDisabled', 'SRATopLevel', 'DISPID_SGRsFindRule',
    'SREStreamEnd', 'ISpeechWaveFormatEx', 'eLEXTYPE_PRIVATE16',
    'DISPID_SRCEAudioLevel', 'SPINTERFERENCE_LATENCY_WARNING',
    'SECNormalConfidence', 'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SGRClear', 'eLEXTYPE_RESERVED10', 'SPAS_CLOSED',
    'SPWF_SRENGINE', 'SPPS_RESERVED2', 'SGRSTTDictation',
    'ISpSerializeState', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRRTOffsetFromStart', 'SPSNoun', 'SREAdaptation',
    'DISPID_SPIEngineId', 'ISpeechCustomStream', 'SVP_13',
    'DISPID_SGRSTWeight', 'SINoise', 'ISpeechPhraseRule',
    'eLEXTYPE_RESERVED4', 'DISPID_SRGReset',
    'SAFTExtendedAudioFormat', 'DISPID_SLRemovePronunciation',
    'DISPID_SpeechPhraseInfo', 'SPCS_ENABLED',
    'DISPID_SpeechWaveFormatEx', 'SSFMOpenForRead', 'SPPHRASEELEMENT',
    'eLEXTYPE_PRIVATE12', 'DISPID_SGRId',
    'SpeechGrammarTagUnlimitedDictation',
    'ISpeechGrammarRuleStateTransitions', 'SRADynamic', 'SGDSActive',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SLWsCount', 'DISPID_SBSRead',
    'SPPROPERTYINFO', 'SPEI_SENTENCE_BOUNDARY',
    'ISpeechRecoResultTimes', 'DISPID_SGRsItem',
    'DISPID_SGRSAddWordTransition', 'SpeechUserTraining', 'SPEVENT',
    'DISPID_SVSLastBookmark', 'ISpeechVoiceStatus',
    'SPEI_PHRASE_START', 'SPBO_PAUSE', 'SpeechEngineProperties',
    'SAFTADPCM_8kHzMono', 'STCInprocServer', 'SPPS_RESERVED1',
    'DISPID_SPEDisplayAttributes', 'SPSNotOverriden', 'SP_VISEME_15',
    'SPSHORTCUTPAIRLIST', 'SECFNoSpecialChars', 'DISPID_SPIStartTime',
    'DISPID_SABufferInfo', 'SPGRAMMARSTATE', 'SVP_16',
    'DISPID_SRRPhraseInfo', 'SP_VISEME_3', 'SREPropertyNumChange',
    'SPEI_UNDEFINED', 'DISPID_SpeechRecoContextEvents', 'SDTRule',
    'DISPID_SVRate', 'SAFT24kHz16BitMono', 'eLEXTYPE_PRIVATE8',
    'SpeechPartOfSpeech', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPIReplacements',
    'SpeechRecoEvents', 'SRTExtendableParse', 'SPSHT_Unknown',
    'DISPID_SRSSupportedLanguages', 'SPRULESTATE',
    'DISPID_SPRs_NewEnum', 'DISPID_SpeechAudio', 'SPPHRASERULE',
    'SVF_Emphasis', 'DISPID_SpeechVoice', 'DISPID_SOTCategory',
    'eLEXTYPE_PRIVATE11', 'STSF_AppData',
    'DISPID_SRSNumberOfActiveRules', 'SPAR_Medium',
    'DISPID_SGRAddResource', 'SAFT16kHz16BitStereo', 'SRCS_Disabled',
    'DISPID_SVSpeakCompleteEvent', 'SpeechCategoryVoices',
    'SPFM_NUM_MODES', 'DISPID_SPIAudioSizeTime', 'SpeechLoadOption',
    'SECLowConfidence', 'SDTAll', 'SAFT8kHz16BitStereo',
    'DISPID_SRGetPropertyNumber', 'SSSPTRelativeToStart',
    'SPRST_ACTIVE_ALWAYS', 'SpFileStream', 'DISPID_SPARecoResult',
    'DISPID_SPEActualConfidence', 'DISPID_SGRs_NewEnum',
    'DISPID_SDKEnumKeys', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SVAlertBoundary', 'SECFEmulateResult', 'DISPID_SLPsItem',
    'DISPID_SPPId', 'DISPID_SpeechVoiceStatus', 'DISPID_SGRsAdd',
    'ISpStreamFormatConverter', 'ISpeechRecoResult',
    'ISpeechObjectTokenCategory', 'SPSERIALIZEDRESULT',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SDKOpenKey',
    'DISPID_SVDisplayUI', 'SVP_12', 'SP_VISEME_20',
    'DISPID_SPIElements', 'SPBO_AHEAD', 'SpeechRegistryUserRoot',
    'SPWT_PRONUNCIATION', 'SGPronounciation', 'SPPS_Noun',
    'SAFT16kHz16BitMono', 'DISPID_SPRuleName',
    'Speech_StreamPos_Asap', 'SPRS_INACTIVE',
    'DISPID_SPRDisplayAttributes', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SVP_8', 'eLEXTYPE_PRIVATE13', 'DISPID_SpeechPhraseElement',
    'eLEXTYPE_PRIVATE5', 'SPSSuppressWord', 'IStream',
    'SpObjectTokenCategory',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SREHypothesis',
    'SPPS_Noncontent', 'SSTTWildcard', 'SpeechRecoContextState',
    'ISpeechMMSysAudio', 'SPWT_DISPLAY', 'DISPID_SGRAddState',
    'DISPID_SVSLastBookmarkId', 'DISPID_SRCVoice', 'SpObjectToken',
    'SpVoice', 'ISpAudio', 'DISPID_SVSLastResult',
    'DISPID_SMSSetData', 'SpInprocRecognizer', 'SRCS_Enabled',
    'SREAllEvents', 'SPCT_SUB_DICTATION', 'SpInProcRecoContext',
    'SPEI_RESERVED2', 'DISPID_SpeechBaseStream', 'SVSFParseSsml',
    'SLOStatic', 'SpCompressedLexicon', 'DISPID_SpeechPhraseBuilder',
    'SpStream', 'DISPID_SRRTTickCount', 'DISPID_SMSALineId',
    'DISPID_SRCEInterference', 'SP_VISEME_18', 'SPEI_SOUND_START',
    'SAFTGSM610_11kHzMono', 'SGSEnabled',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SABufferNotifySize',
    'DISPID_SRCEPropertyNumberChange', 'SPPS_LMA',
    'SAFT24kHz8BitMono', 'DISPID_SFSClose', 'SSFMCreate',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SVP_14',
    'DISPID_SPRNumberOfElements', 'DISPID_SPRuleChildren',
    'DISPID_SPPName', 'DISPID_SPIGrammarId', 'DISPID_SVEAudioLevel',
    'DISPID_SLGenerationId', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SAStatus', 'SVEPrivate', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRRAlternates', 'SVP_19', 'ISpMMSysAudio',
    'DISPID_SGRAttributes', 'SPGS_DISABLED', 'SPWAVEFORMATTYPE',
    'SREPropertyStringChange', 'SVSFPersistXML',
    'DISPID_SRRGetXMLErrorInfo', 'SITooLoud', 'SPAO_RETAIN_AUDIO',
    'SAFT48kHz8BitStereo', 'DISPID_SpeechLexiconProns',
    'DISPID_SDKSetLongValue', 'DISPID_SRGState',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRCEFalseRecognition',
    'DISPID_SABIBufferSize', 'ISpeechPhoneConverter',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRCERequestUI',
    'SAFT11kHz16BitStereo', 'SpeechTokenKeyUI', 'SVEAllEvents',
    'SVP_21', 'SAFT48kHz8BitMono', 'SVEAudioLevel', 'SPFM_CREATE',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SPPNumberOfElements',
    'eLEXTYPE_LETTERTOSOUND', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SBSFormat', 'DISPID_SPPsItem', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPRuleId', 'SPVPRI_OVER', 'SPDKL_DefaultLocation',
    'SpPhraseInfoBuilder', 'DISPID_SOTGetAttribute',
    'DISPID_SPPsCount', 'eWORDTYPE_ADDED', 'SPEI_END_SR_STREAM',
    'SPBO_TIME_UNITS', 'DISPID_SRSAudioStatus',
    'SpeechRegistryLocalMachineRoot', 'SpeechRecoProfileProperties',
    'SRERecognition', 'SVEPhoneme', 'SPXRO_SML', 'SLODynamic',
    'DISPID_SpeechXMLRecoResult', 'SINoSignal', 'SPAUDIOSTATE',
    'SAFTCCITT_ALaw_11kHzStereo', 'SDA_Two_Trailing_Spaces',
    'DISPID_SPCLangId', 'SpSharedRecognizer',
    'SAFTCCITT_uLaw_11kHzStereo', 'eLEXTYPE_PRIVATE14', 'SPAS_STOP',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SLPLangId',
    'eLEXTYPE_PRIVATE4', 'SPINTERFERENCE_TOOFAST', 'DISPID_SVSkip',
    'DISPID_SRGSetTextSelection', '_ISpeechRecoContextEvents',
    'DISPID_SOTId', 'SPVOICESTATUS', 'DISPID_SpeechRecoResultTimes',
    'SPEI_START_INPUT_STREAM', 'SpeechTokenContext',
    'DISPID_SRAudioInput', 'SP_VISEME_10', 'DISPID_SRProfile',
    ...
    'SP_VISEME_4', 'ISpeechLexiconPronunciation', 'DISPID_SAFType',
    'DISPID_SPAStartElementInResult', 'eLEXTYPE_USER_SHORTCUT',
    'SAFTADPCM_44kHzStereo', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SADefaultFormat', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SPRulesItem', 'SAFTNoAssignedFormat',
    'SPWORDPRONOUNCEABLE', 'DISPID_SLGetWords', 'ISpProperties',
    'DISPID_SLPPhoneIds', 'DISPID_SRCPause', 'DISPID_SRRGetXMLResult',
    'ISpeechGrammarRuleState', 'SFTInput', 'SPRST_ACTIVE',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPSEMANTICERRORINFO',
    'DISPID_SPEAudioSizeTime', 'DISPID_SPRsItem', 'SPAO_NONE',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SPAsCount',
    'DISPID_SVEBookmark', 'DISPID_SBSSeek', 'SAFT48kHz16BitStereo',
    'ISpRecognizer3', 'SPSUnknown', 'ISpeechPhraseReplacement',
    'ISpNotifySink', 'ISpeechObjectTokens', 'SPWORDPRONUNCIATION',
    'ISpeechPhraseReplacements', 'ISpResourceManager',
    'SPSEMANTICFORMAT', 'DISPID_SRCCreateGrammar',
    'DISPID_SLWPronunciations', 'ISpStream', 'SPEVENTENUM',
    'SAFT44kHz8BitMono', 'SP_VISEME_16', 'DISPID_SASetState',
    'DISPID_SRStatus', 'DISPID_SDKEnumValues',
    'ISpPhoneticAlphabetConverter', 'DISPID_SpeechPhraseReplacements',
    'SPFM_OPEN_READONLY', 'SPCT_SLEEP',
    'SpeechPropertyComplexResponseSpeed', 'SAFT8kHz16BitMono',
    'eLEXTYPE_PRIVATE20', 'SGRSTTRule', 'SpeechSpecialTransitionType',
    'SAFT48kHz16BitMono', 'SECFIgnoreWidth', 'SPEI_SR_BOOKMARK',
    'SAFT24kHz8BitStereo', 'DISPID_SpeechObjectTokens', 'SVP_18',
    'DISPID_SVSVisemeId', 'DISPID_SRCState', 'SPLO_DYNAMIC',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SVSInputWordPosition',
    'SDA_One_Trailing_Space', 'SAFTCCITT_uLaw_44kHzStereo',
    'SRADefaultToActive', 'SRSInactiveWithPurge',
    'SPDKL_CurrentConfig', 'DISPID_SDKGetlongValue',
    'SAFTCCITT_ALaw_8kHzMono', 'SPPS_RESERVED4', 'IEnumString',
    'DISPID_SASNonBlockingIO', 'SVSFlagsAsync', 'SPPS_Verb',
    'DISPID_SVWaitUntilDone', 'SAFTNonStandardFormat', 'SP_VISEME_5',
    'DISPID_SPPChildren', 'DISPID_SRCEStartStream',
    'DISPID_SRGCmdLoadFromObject', 'SpeechLexiconType',
    'DISPID_SRIsShared', 'DISPID_SpeechPhraseReplacement',
    'SPEI_PROPERTY_NUM_CHANGE', 'SAFT32kHz16BitMono',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SCSBaseStream',
    'SpeechRunState', 'DISPID_SPEs_NewEnum', 'SITooQuiet',
    'eLEXTYPE_RESERVED6', 'DISPID_SGRName', 'SVP_17', 'SBONone',
    'SDTPronunciation', 'STCInprocHandler', 'ISpeechFileStream',
    'DISPID_SAFGetWaveFormatEx', 'ISpObjectWithToken',
    'SPAUDIOBUFFERINFO', 'DISPID_SPPs_NewEnum',
    'DISPID_SRCERecognizerStateChange', 'SVF_None',
    'eLEXTYPE_MORPHOLOGY', 'IInternetSecurityMgrSite',
    'DISPID_SOTCGetDataKey', 'SPEI_RESERVED3', 'ISpeechBaseStream',
    'eLEXTYPE_PRIVATE10', 'SpeechGrammarTagWildcard',
    'DISPID_SVVoice', 'DISPID_SRGCmdSetRuleState',
    'SPFM_CREATE_ALWAYS', 'SPCT_SUB_COMMAND', 'SPEI_TTS_AUDIO_LEVEL',
    'SVSFUnusedFlags', 'DISPID_SLGetGenerationChange',
    'SpeechTokenKeyFiles', 'SRSEDone', 'ISpeechPhraseAlternates',
    'SPINTERFERENCE_NOSIGNAL', 'SPEI_TTS_PRIVATE',
    ...
    'ISpEventSink', 'DISPID_SOTCEnumerateTokens', 'SLTApp',
    'SpeechRecognizerState', 'SAFTGSM610_22kHzMono',
    'DISPID_SVSPhonemeId', 'DISPID_SMSAMMHandle',
    'ISpNotifyTranslator', 'DISPID_SpeechAudioFormat',
    'DISPID_SpeechPhraseRules', 'DISPID_SOTs_NewEnum',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpeechMemoryStream',
    'SWPUnknownWordUnpronounceable', 'SAFT44kHz8BitStereo',
    'eLEXTYPE_USER', 'DISPID_SVEStreamStart', 'SRARoot',
    'SAFT16kHz8BitMono', 'DISPID_SLPsCount', 'DISPID_SOTsItem',
    'SPEI_ADAPTATION', 'eLEXTYPE_PRIVATE3', 'SGLexicalNoSpecialChars',
    'SpeechAudioState', 'DISPID_SpeechPhraseElements',
    'DISPID_SGRInitialState', 'ISpeechGrammarRule', 'SSTTDictation',
    'SPWF_INPUT', 'SITooFast', 'ISpeechDataKey',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SPRuleConfidence',
    'ISpeechPhraseElements', 'DISPID_SVAudioOutputStream',
    'ISpeechRecoGrammar', 'DISPID_SRCEBookmark', 'SPSModifier',
    'DISPID_SASCurrentDevicePosition', 'ISpeechGrammarRules',
    'SpeechRetainedAudioOptions', 'SpeechTokenIdUserLexicon',
    'SPINTERFERENCE_TOOLOUD', 'SAFT32kHz8BitMono',
    'ISpObjectTokenCategory', 'SAFT11kHz16BitMono',
    'DISPID_SRSetPropertyString', 'SpeechRuleAttributes', 'SPSVerb',
    'SVSFIsXML', 'DISPID_SRCESoundEnd', 'DISPID_SBSWrite',
    'SpeechCategoryPhoneConverters', 'DISPID_SOTCId',
    'SpeechVoiceSpeakFlags', 'SpeechCategoryAudioIn',
    '__MIDL_IWinTypes_0009', 'SDTProperty', 'SDTReplacement',
    'SpNullPhoneConverter', 'SP_VISEME_6',
    'ISpPhoneticAlphabetSelection', 'ISpeechPhraseProperties',
    'SPSHORTCUTPAIR', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPIDSPTSI_SelectionOffset', 'eLEXTYPE_PRIVATE7',
    'tagSPPROPERTYINFO', 'SAFT8kHz8BitMono', 'ISpVoice',
    'DISPID_SGRSTs_NewEnum', 'DISPIDSPTSI_ActiveLength', 'SVP_7',
    'SPBO_NONE', 'DISPID_SPIGetText', 'DISPID_SPIAudioStreamPosition',
    'SAFTCCITT_ALaw_8kHzStereo', 'ISpRecognizer2',
    'eLEXTYPE_PRIVATE17', 'DISPID_SpeechRecoResult', 'SRSInactive',
    'SP_VISEME_14', 'DISPID_SPRsCount', 'SpeechMicTraining',
    'eLEXTYPE_APP', 'DISPID_SVEventInterests', 'DISPID_SGRSTType',
    ...
    'ISpeechObjectToken', 'SDTAlternates',
    'DISPID_SpeechPhraseProperties', 'SDTDisplayText',
    'SPEI_SR_PRIVATE', 'SpeechCategoryRecoProfiles',
    ...
    'ISpeechPhraseAlternate', 'SpeechDiscardType',
    'eLEXTYPE_PRIVATE6', 'DISPID_SRCRecognizer', 'SPFILEMODE',
    'DISPID_SRCSetAdaptationData', 'DISPID_SVESentenceBoundary',
    'SPWORDTYPE', 'DISPID_SLPs_NewEnum', 'SPADAPTATIONRELEVANCE',
    'SP_VISEME_19', 'DISPID_SVSRunningState', 'DISPIDSPRG',
    'ISpPhrase', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SPRFirstElement', 'SpeechGrammarState',
    'DISPID_SVPriority', 'SP_VISEME_7', 'DISPID_SRRRecoContext',
    ...
    'SPAUDIOOPTIONS', 'DISPID_SpeechGrammarRuleState', 'SVP_2',
    'ISpStreamFormat', 'SpWaveFormatEx', 'DISPID_SWFEExtraData',
    'SVEWordBoundary', 'SpeechDataKeyLocation', 'SPPS_Modifier',
    'SSSPTRelativeToEnd', 'DISPID_SRSCurrentStreamNumber',
    'SAFTADPCM_11kHzStereo', 'SpeechCategoryRecognizers',
    'SpUnCompressedLexicon', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SPPValue', 'DISPID_SRIsUISupported',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SRGCmdLoadFromResource',
    'SPINTERFERENCE_NOISE', 'SPRST_NUM_STATES', 'SPCT_DICTATION',
    'SPPHRASE', 'ISpRecoResult', 'SpeechBookmarkOptions',
    'eLEXTYPE_RESERVED7', 'DISPID_SDKDeleteKey',
    'SpeechPropertyAdaptationOn', 'SPRECOSTATE', 'SAFT44kHz16BitMono',
    'SRAONone', 'DISPID_SRCRequestedUIType',
    'DISPID_SRGSetWordSequenceData', 'SGRSTTTextBuffer',
    'SPLO_STATIC', 'SVSFParseAutodetect', 'DISPID_SLWWord',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRCERecognition',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SASState', 'STSF_CommonAppData',
    'SpeechWordPronounceable', 'SPWORDLIST',
    'DISPID_SpeechCustomStream', 'SVSFParseMask', 'SpMMAudioEnum',
    'SpCustomStream', 'SPBINARYGRAMMAR', 'SVSFNLPMask',
    'SAFT12kHz16BitStereo', 'DISPID_SLGetPronunciations',
    'SpeechStreamSeekPositionType', 'DISPID_SPRulesCount',
    'SP_VISEME_2', 'SPAS_RUN', 'DISPID_SLPPartOfSpeech',
    'DISPID_SMSADeviceId', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SpeechLexicon', 'eLEXTYPE_RESERVED9',
    'ISpeechRecognizerStatus', 'DISPIDSPTSI',
    'DISPID_SRSCurrentStreamPosition', 'SVPOver', 'SpeechVisemeType',
    'SPCATEGORYTYPE', 'DISPID_SVSpeakStream', 'DISPID_SPILanguageId',
    'SDTAudio', 'SRERequestUI', 'SPRS_ACTIVE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SGDSActiveUserDelimited', 'DISPID_SWFEFormatTag',
    'DISPID_SRGCommit', 'DISPID_SPEsItem', 'ISpPhraseAlt',
    'DISPID_SRRAudio', 'SPSFunction', 'DISPID_SpeechRecoContext',
    'DISPID_SPIGetDisplayAttributes', 'SPSHORTCUTTYPE',
    'SpeechPropertyLowConfidenceThreshold', 'SPEI_REQUEST_UI',
    'SP_VISEME_13', 'ISpRecoCategory', 'DISPIDSPTSI_ActiveOffset',
    'SVP_20', 'DISPID_SPAs_NewEnum',
    'DISPID_SVSInputSentencePosition', 'eLEXTYPE_PRIVATE1',
    'SpeechFormatType', 'Speech_Max_Word_Length',
    'DISPID_SVSInputSentenceLength', 'SAFT24kHz16BitStereo',
    'DISPID_SRCRetainedAudio', 'DISPID_SVSCurrentStreamNumber',
    'SDKLDefaultLocation', 'ISpeechLexiconWord', 'SPPS_RESERVED3',
    'DISPID_SVEVoiceChange', 'SDTLexicalForm',
    'DISPID_SRGetRecognizers', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SRCEHypothesis', 'SAFTADPCM_44kHzMono',
    'IEnumSpObjectTokens', 'DISPID_SGRSTsItem',
    'DISPID_SGRSTPropertyId', 'DISPID_SVAudioOutput',
    'SVEVoiceChange', 'SPPHRASEPROPERTY', 'SPEI_MIN_SR',
    'DISPID_SLWsItem', 'DISPID_SVGetAudioInputs',
    'SpSharedRecoContext', 'SPEI_RESERVED1', 'SPINTERFERENCE',
    'DISPID_SOTCreateInstance', 'DISPID_SRCEEndStream',
    'DISPID_SABIEventBias', 'DISPID_SOTIsUISupported',
    'SpeechAllElements', 'SRAORetainAudio', 'SVSFParseSapi',
    'DISPID_SWFESamplesPerSec', 'DISPID_SDKDeleteValue',
    '_RemotableHandle', 'SpeechPropertyResponseSpeed',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPCIdToPhone',
    'DISPID_SPAPhraseInfo', 'DISPID_SVEStreamEnd', 'SINone',
    'STSF_LocalAppData', 'ISpEventSource',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SGRSRule',
    'SpeechGrammarTagDictation', 'SAFTDefault', 'SREFalseRecognition',
    'SPDATAKEYLOCATION', 'STCLocalServer', 'DISPID_SOTDisplayUI',
    'eLEXTYPE_PRIVATE18', 'DISPID_SGRSTNextState',
    'SAFT32kHz16BitStereo', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SOTCDefault', 'DISPID_SRCESoundStart',
    'ISequentialStream', '_SPAUDIOSTATE', 'ISpLexicon',
    'SpeechTokenValueCLSID', 'SpAudioFormat', 'ISpeechAudioStatus',
    ...
    'DISPID_SVEEnginePrivate', 'DISPID_SGRSTPropertyName',
    'ISpNotifySource', 'ISpeechPhraseInfo',
    'DISPID_SGRsCommitAndSave', 'SpTextSelectionInformation',
    'SPAS_PAUSE', 'ISpeechAudioBufferInfo',
    'DISPID_SRGetPropertyString', 'SAFT32kHz8BitStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SRTSMLTimeout',
    'DISPID_SGRSTsCount', 'SRERecoOtherContext', 'ISpeechRecoResult2',
    'IInternetSecurityManager', 'DISPID_SPIProperties',
    'Speech_StreamPos_RealTime', 'DISPID_SLAddPronunciation',
    'SpeechDisplayAttributes', 'eWORDTYPE_DELETED', 'SPWT_LEXICAL',
    'DISPID_SPIEnginePrivateData', 'SVEViseme', 'SpeechVisemeFeature',
    'ISpeechResourceLoader', 'SLTUser', 'ISpDataKey',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SPEsCount',
    'DISPID_SLPType', 'SVSFDefault', 'DISPID_SVPause',
    'DISPID_SPEPronunciation', 'SASStop', 'DISPID_SPRules_NewEnum',
    'DISPID_SREmulateRecognition', 'SDKLCurrentConfig',
    'DISPID_SRGDictationUnload', 'SPXRO_Alternates_SML',
    'SAFTADPCM_8kHzStereo', 'DISPID_SpeechRecoResult2',
    'DISPID_SWFEBlockAlign', 'SVEStartInputStream', 'SPGS_EXCLUSIVE',
    'SVP_6', 'SPINTERFERENCE_NONE', 'DISPID_SOTSetId',
    'DISPID_SVSpeak', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SLWs_NewEnum',
    'SREStreamStart', 'SPINTERFERENCE_TOOSLOW', 'DISPID_SPAsItem',
    'SpeechDictationTopicSpelling', 'SpeechPropertyResourceUsage',
    'DISPID_SPELexicalForm', 'ISpObjectToken', 'ISpRecoGrammar',
    'DISPID_SRDisplayUI', 'SPRECOCONTEXTSTATUS', 'DISPID_SMSGetData',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpeechPhraseElement',
    'SpPhoneConverter', 'SpStreamFormatConverter',
    'SpeechGrammarWordType', 'SPEI_MAX_TTS', 'SpMMAudioIn',
    'SpShortcut', 'ISpeechPhraseRules', 'DISPID_SRRecognizer',
    'SPCONTEXTSTATE', 'DISPID_SpeechFileStream', 'SPAR_High',
    'SECFIgnoreCase', 'DISPID_SASFreeBufferSpace', 'UINT_PTR',
    'ISpeechRecognizer', 'DISPID_SPEEngineConfidence',
    'STSF_FlagCreate', 'SPEI_SOUND_END', 'SRTStandard',
    'DISPID_SLAddPronunciationByPhoneIds', 'SDA_No_Trailing_Space',
    'SREPhraseStart', 'DISPID_SOTDataKey',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SDKGetStringValue',
    'SpeechWordType', 'DISPID_SOTsCount', 'DISPID_SGRsDynamic',
    'SREPrivate', 'SVP_1', 'SpResourceManager', 'SSFMOpenReadWrite',
    'SPGS_ENABLED', 'DISPID_SWFEBitsPerSample', 'SPVISEMES',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SVEPhoneme',
    'SPSHT_EMAIL', 'ISpeechAudioFormat', 'SPEI_RECOGNITION',
    'SRTAutopause', 'Speech_Max_Pron_Length', 'SAFTADPCM_11kHzMono',
    'SFTSREngine', 'ISpRecoGrammar2', 'tagSPTEXTSELECTIONINFO',
    'SVP_3', 'SAFT22kHz16BitStereo', 'DISPID_SpeechGrammarRules',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPEI_MAX_SR', 'DISPID_SGRSTText',
    'DISPID_SpeechPhoneConverter', 'SP_VISEME_8',
    'DISPID_SPPEngineConfidence', 'DISPID_SGRsCount',
    'SVSFNLPSpeakPunc', 'DISPID_SOTCSetId', 'DISPID_SRCResume',
    'ISpGrammarBuilder', 'SGDisplay', 'SPPS_Function',
    'SAFT11kHz8BitMono', 'STCAll', 'DISPID_SOTRemoveStorageFileName',
    'SGRSTTWord', 'ISpeechLexiconWords', 'DISPID_SpeechMemoryStream',
    'SPAUDIOSTATUS', 'tagSTATSTG', 'SPEI_VOICE_CHANGE',
    'DISPID_SPIAudioSizeBytes', 'SRSActiveAlways', 'STCRemoteServer',
    'SVP_4', 'DISPID_SpeechAudioBufferInfo', 'SASRun',
    'SAFT22kHz8BitMono', 'eLEXTYPE_PRIVATE15', 'SPBOOKMARKOPTIONS',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SRSetPropertyNumber',
    'DISPID_SGRSTransitions', 'DISPID_SPCPhoneToId',
    'SAFT12kHz8BitMono', 'SPLEXICONTYPE', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SPEDisplayText', 'SP_VISEME_17', 'SPRULE',
    'SpeechCategoryAppLexicons', 'SPPHRASEREPLACEMENT',
    'DISPID_SOTMatchesAttributes', 'SP_VISEME_0', 'DISPID_SRGId',
    'SpMemoryStream', 'ISpRecoContext',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SGRSTRule', 'SWTAdded',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SPRText', 'SPSLMA',
    'SGSExclusive', 'DISPID_SPIRetainedSizeBytes', 'SPPARTOFSPEECH',
    'SPEI_TTS_BOOKMARK', 'DISPID_SRCreateRecoContext',
    'DISPID_SVGetProfiles', 'SAFTCCITT_uLaw_22kHzMono',
    'SpeechTokenKeyAttributes', 'ISpeechXMLRecoResult',
    'SP_VISEME_11', 'DISPID_SRRAudioFormat', 'ISpXMLRecoResult',
    'DISPID_SRAudioInputStream', 'SRAInterpreter', 'SPEI_HYPOTHESIS',
    'SpeechAudioProperties', 'SRAImport', 'SASClosed',
    'DISPID_SRGetFormat', 'SAFT12kHz8BitStereo', 'DISPID_SVEViseme',
    'SPWORD', 'SpeechAudioVolume', 'SPSTREAMFORMATTYPE',
    'ISpRecoContext2', 'SPSMF_UPS', 'DISPID_SRRSetTextFeedback',
    'SPEI_RESERVED5', 'DISPID_SRGRules',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'ISpeechLexiconPronunciations', 'SPPS_NotOverriden',
    'DISPID_SAEventHandle', 'ISpPhoneConverter',
    'DISPID_SDKCreateKey', 'SVPNormal', 'DISPID_SRState', 'SGLexical',
    'eLEXTYPE_VENDORLEXICON', 'SRTEmulated', 'SPEI_PHONEME',
    'DISPID_SpeechAudioStatus', 'DISPID_SPERequiredConfidence'
]
